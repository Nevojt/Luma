...
class PaintApp:
    def __init__(self, root):
        ...
        tk.Button(control_frame, text="Yellow", command=lambda: self.set_color("yellow")).pack(side=tk.LEFT, padx=5)
        tk.Button(control_frame, text="White", command=lambda: self.set_color("white")).pack(side=tk.LEFT, padx=5)
        ...
        self.size_slider = tk.Scale(size_frame, from_=1, to=20, orient=tk.HORIZONTAL,
